...
//TABLE
import HelperTable from '../table/helpers/paymentprofilelist';
...
function Helperpaymentprofilelisting({setSuccessModal}) {
...
export default Helperpaymentprofilelisting