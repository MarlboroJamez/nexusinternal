            ...
            {/*body*/}
                <div className="w-fit relative h-fit grid place-items-center p-6 flex-auto">
                    ...
                    <div className="h-fit w-80 text-neutral-600 text-sm p-2 rounded shadow-inner border border-neutral-200 bg-neutral-100">
                        <p>
                        Our cutting-edge fraud prevention and identification tool is designed to verify bank information for both individuals and legal entities by accessing the records of all major banks in South Africa. By leveraging this extensive network of data sources, we can accurately and efficiently identify instances of fraudulent activity and take swift action to prevent financial losses. This tool is an essential component of our comprehensive approach to risk management and security, providing our clients with the peace of mind they need to conduct business with confidence.
                        </p>
                    </div>
