...
//TABLE
import HelperTable from '../table/helpers/identityverificationlisting';
...
function Helperidentityverificationlisting({setSuccessModal}) {
...
export default Helperidentityverificationlisting