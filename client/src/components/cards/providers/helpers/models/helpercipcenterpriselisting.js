...
//TABLE
import HelperTable from '../table/helpers/cipcenterpriselisting';
...
function Helpercipcenterpriselisting({setSuccessModal}) {
...
export default Helpercipcenterpriselisting