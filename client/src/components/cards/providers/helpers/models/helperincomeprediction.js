...
//TABLE
import HelperTable from '../table/helpers/incomepredictionlisting';
...
function Helperincomeprediction({setSuccessModal}) {
...
export default Helperincomeprediction