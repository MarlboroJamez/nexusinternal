    ...
    <div className="p-2 mb-10 rounded border border-neutral-200 w-full shadow-lg">
        <ul className="flex cursor-pointer">
            ...
            :"mr-10 transition duration-400 hover:bg-sky-500 h-fit rounded bg-sky-600 text-white shadow p-2 w-fit font-medium"}>
                Individual Bank Account Verification
            </li>
            <li
    ...
    {view === "about" &&
        ...
        {view === "search" && (
            ...
            <div className='grid mb-6 '>
                <label className='mt-1 text-xs w-full text-right font-bold mb-0.5'>E.g. Individual - Bank Verification</label>
                {/* SEARCH TITLE */}
                <input 
                value={header}
            ...
            <div className='mb-6 grid'>
                <label className='mt-1 text-xs w-full text-right font-bold mb-0.5'>E.g. SAID: South African Identification</label>
                {/* IDENTIFICATION TYPE */}
                <select 
                ...
                className={identificationType.length <=0 ? "cursor-pointer h-fit text-sm rounded border border-red-400 bg-white shadow p-2 w-80":"cursor-pointer h-fit text-sm rounded border border-neutral-200 bg-white shadow p-2 w-80"}>
                    ...
                    <option value="SAID">SAID: South African Identification</option>
                    <option value="SAPA">SAPA: South African Passport</option>
                    <option value="FOPA">FOPA: Foreign Passport</option>
                    <option value="SATR">SATR: South African Temporary Residence</option>
                </select>
                ...
                <div className="grid ml-12 h-fit"><div className='mb-6 grid'>
        ...
        <div className='mb-6 grid'>
            <label className='mt-1 text-xs w-full text-right font-bold mb-0.5'>E.g. example@gmail.com</label>
            {/* EMAIL */}
            <input 
            value={email}
        ...
        <div className='mb-6 grid'>
            <label className='mt-1 text-xs w-full text-right font-bold mb-0.5'>E.g. 082 047 2034</label>
            {/* PHONE NUMBER */}
            <input 
            value={phoneNumber}
        ...
        <div className='mb-6 grid'>
            <label className='mt-1 text-xs w-full text-right font-bold mb-0.5'>E.g. John</label>
            {/* FIRSTNAME */}
            <input 
            value={firstName}
            ...
            {error&firstName.length <= 0 ? <label className='mt-1 text-red-400 text-xs'>This is a required field</label>:<label className='mt-1 text-xs'>FirstName defaults to</label>}
        </div>

        <div className='mb-6 grid'>
            <label className='mt-1 text-xs w-full text-right font-bold mb-0.5'>E.g. Wick</label>
            {/* SURNAME */}
            <input 
            value={surname}
            ...
            {error&surname.length <= 0 ? <label className='mt-1 text-red-400 text-xs'>This is a required field</label>:<label className='mt-1 text-xs'>Surname defaults to</label>}
        </div>
