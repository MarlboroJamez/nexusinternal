...
function Personlisting({share, notified, project}) {
    ...
    const handleSubmission = async (e) => {
        ...
        const parameters = {
            ...
            restrictionName: "CIPC Directors List",
        ...
        try {
            if(reference.length === 0 || idNumber.length === 0 || header.length === 0){
                ...
                setLoading(true)
                const {data} = axios.post('/api/v1/provider/cpb/schedule/cipcdirectorslist',{
                    date: date,
                    uid: cookieValue._id,
    ...
    {view === "about" &&
        ...
        {view === "search" && (
            ...
            <div className="flex mt-12 w-full">
                ...
                <div className='mb-6 grid'>
                    <label className='mt-1 text-xs w-full text-right font-bold mb-0.5'>E.g. 2005/034941/07</label>
