    ...
    <div>
        ...
        <div className="flex mt-6">
            ...
            <div className="grid ml-10 h-fit">
                ...
                className='w-72 rounded shadow-md bg-neutral-300 p-2 text-sm cursor-pointer hover:bg-neutral-200 outline-none'>
                    <option selected>Has Consent?</option>
                ...
                className='w-72 rounded shadow-md bg-neutral-300 p-2 text-sm cursor-pointer hover:bg-neutral-200 outline-none'>
                    ...
                    <option value="idvalidation">ID Validation</option>
                    <option value="idvalidationphoto">ID Validation Photo</option>
                    <option value="idissued">ID Issued</option>
                    <option value="deceasedstatus">Deceased Status</option>
