        ...
        <div className="flex mt-6">
            ...
            <div className="grid ml-10 h-fit">
                <div className='grid mb-4'>
                    ...
                    className="h-fit text-sm rounded border border-neutral-200 bg-white shadow p-2 w-72"/>
                    <label className='mt-1 text-xs'>Please provide a valid Registration Number</label>
                </div>
                ...
                <div className='grid mb-4'>
                    ...
                    placeHolder="Registration Number"
                    className="h-fit text-sm rounded border border-neutral-200 bg-white shadow p-2 w-72"/>
                    <label className='mt-1 text-xs'>Please provide your Trust Number if ID is not provided.</label>
                </div>
