...
// Assets
import Guide from '../../../../../assets/guides/dynamic.pdf'
        ...
        const licenseInfo = async () => {
            if(cookieValue){
                if(cookieValue.license){
                    ...
                    setLicense(data.data[0].restrictions.filter((res) => res.type === "Dynamic Report"))
                    setAccess(cookieValue.license[0].restrictions.filter(item => item.type === "Dynamic Report"))
                }
            }
        }
        licenseInfo()
    ...
    const handleSubmission = async (e) => {
        ...
        try {
                if(reference.length === 0 || idNumber === 0){
                    ...
                    const {data} = await axios.post('/api/v1/provider/cpb/search/dynamicwrapper', {
                        ...
                        share: true,
                        restrictionName: "Dynamic Report",
            ...
            <table className='w-full text-left mt-10'>
                ...
                <tbody className='text-sm'>
                    <tr>
                        ...
                        <td className='p-2 border border-neutral-200'>Dynamic Reports</td>
