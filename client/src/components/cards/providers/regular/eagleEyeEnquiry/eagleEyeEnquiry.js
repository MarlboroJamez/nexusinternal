    ...
    <div>
        ...
        <div className="flex mt-6">
            <div className="grid h-fit">
                ...
                placeHolder="Scope"
                className="h-fit text-sm rounded border border-neutral-200 bg-white shadow p-2 w-72"/>
                    <label className='mt-1 text-xs'>Please provide you scope of search (broad)</label>
                </div>
                <div className='grid mb-4'>
                    {/* SECOND NAME */}
                    <input 
                    ...
                    className="h-fit text-sm rounded border border-neutral-200 bg-white shadow p-2 w-72"/>
                        <label className='mt-1 text-xs'>Please provide a start date to your search?</label>
                </div>
            ...
            <div className="grid ml-10 h-fit">
                <div className='grid mb-4'>
                    ...
                    className="h-fit text-sm rounded border border-neutral-200 bg-white shadow p-2 w-72"/>
                    <label className='mt-1 text-xs'>Refine your search by providing another search term</label>
                </div>
                <div className="mb-4 grid">
                    {/* ID NUMBER */}
                    <input 
                ...
                <div className="mb-4 grid">
                    ...
                    className="h-fit text-sm rounded border border-neutral-200 bg-white shadow p-2 w-72"/>
                    <label className='mt-1 text-xs'>Please provide a Enquiry Reason</label>
                </div>
