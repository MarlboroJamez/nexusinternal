...
function Searchesbarchart({searches}) {
  ...
  return (
    <div className='w-full max-w-lg h-100 p-3 rounded bg-white border-neutral-300 shadow-lg'>
        <h1 className='mb-2 font-bold text-center text-xl text-neutral-600'>
           Categorised by Priority
        </h1>
        <p className='text-center text-sm'>
        Total number of searches performed based on the type of project.
        </p>
      <Chart 
