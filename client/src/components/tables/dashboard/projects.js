...
function Table({ data }) {
  ...
  const headers = data.length > 0 ? Object.keys(data[0]).filter(item => item !== "search" && item !== "resetPasswordExpire" && item !== "__v" && item !== "startDate" && item !== "endDate" && item !== "_id" && item !== "package" && item !== "reports" && item !== "searches" && item !== "license" && item !== "members"):"";
